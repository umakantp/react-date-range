...
class Calendar extends _react.PureComponent {
    ...
    _defineProperty(this, "focusToDate", function (date) {
      ...
      if (!props.scroll.enabled) {
        if (preventUnnecessary && props.preventSnapRefocus) {
          const focusedDateDiff = dateFns.differenceInCalendarMonths(date, _this.state.focusedDate);
      ...
      const targetMonthIndex = dateFns.differenceInCalendarMonths(date, props.minDate, _this.dateOptions);
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      length: dateFns.differenceInCalendarMonths(dateFns.endOfMonth(maxDate), dateFns.addDays(dateFns.startOfMonth(minDate), -1), this.dateOptions),
      treshold: 500,
      type: "variable",
