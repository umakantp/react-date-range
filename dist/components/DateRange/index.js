...
class DateRange extends _react.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "calcNewSelection", function (value) {
      ...
      return (0, _utils.calcNewSelection)(value, isSingleValue, focusedRange, ranges, onChange, maxDate, moveRangeOnFirstSelection, retainEndDateOnFirstSelection, disabledDates);
    });
