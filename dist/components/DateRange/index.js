...
class DateRange extends _react.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "calcNewSelection", function (value) {
      ...
      const correctRanges = (0, _utils.restrictMinMaxDate)(ranges, _this.props.minDate, _this.props.maxDate);
      return (0, _utils.calcNewSelection)(value, isSingleValue, focusedRange, correctRanges, onChange, maxDate, moveRangeOnFirstSelection, retainEndDateOnFirstSelection, disabledDates);
    });
    ...
    const _ranges = (0, _utils.restrictMinMaxDate)(props.ranges, props.minDate, props.maxDate);
    this.state = {
      focusedRange: props.initialFocusedRange || [(0, _utils.findNextRangeIndex)(_ranges), 0],
      preview: null
    };
