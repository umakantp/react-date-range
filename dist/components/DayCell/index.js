...
class DayCell extends _react.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "renderPreviewPlaceholder", () => {
      ...
      const isInRange = (!startDate || dateFns.isAfter(day, startDate)) && (!endDate || dateFns.isBefore(day, endDate));
  ...
  render() {
    ...
    }, dayContentRenderer?.(this.props.day) || /*#__PURE__*/_react.default.createElement("span", null, dateFns.format(this.props.day, this.props.dayDisplayFormat))));
  }
}
